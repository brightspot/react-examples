...
2. [Route a React app based on the URL path](#step-2-route-a-react-app-based-on-the-url-path)
3. [Handle redirects based on URL path metadata](#step-3-handle-redirects-based-on-url-path-metadata)
