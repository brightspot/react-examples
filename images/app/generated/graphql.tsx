...
export type GetImageUrlBySizeNameQuery = { __typename?: 'Query', Image?: { __typename?: 'Image', title?: string | null, imageFile?: { __typename?: 'ImageAttributes', size?: { __typename?: 'ImageSize', src?: string | null, height?: number | null, width?: number | null, name?: string | null, srcSets: Array<{ __typename?: 'ImageSrcSet', size?: string | null, src?: string | null }> } | null } | null } | null };
 ...
 * });
 */
export function useGetImageUrlBySizeNameQuery(baseOptions?: Apollo.QueryHookOptions<GetImageUrlBySizeNameQuery, GetImageUrlBySizeNameQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetImageUrlBySizeNameQuery, GetImageUrlBySizeNameQueryVariables>(GetImageUrlBySizeNameDocument, options);
      }
export function useGetImageUrlBySizeNameLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetImageUrlBySizeNameQuery, GetImageUrlBySizeNameQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetImageUrlBySizeNameQuery, GetImageUrlBySizeNameQueryVariables>(GetImageUrlBySizeNameDocument, options);
        }
export type GetImageUrlBySizeNameQueryHookResult = ReturnType<typeof useGetImageUrlBySizeNameQuery>;
export type GetImageUrlBySizeNameLazyQueryHookResult = ReturnType<typeof useGetImageUrlBySizeNameLazyQuery>;
export type GetImageUrlBySizeNameQueryResult = Apollo.QueryResult<GetImageUrlBySizeNameQuery, GetImageUrlBySizeNameQueryVariables>;
