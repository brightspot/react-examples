...
Navigate to `brightspot/src/examples/apq`. This directory contains the JS Classes files that are uploaded to Brightspot.
...
> **_Note_** This is purely an example application! In production, it is important when using a secret that is hashed with the query hidden.
