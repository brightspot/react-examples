...
import RestManagementEndpoint from './RestManagementEndpoint'

export default class RestManagementClient extends JavaClass(
  'brightspot.example.ssg_with_webhooks.RestManagementClient',
  Modification.Of(RestManagementEndpoint)
) {
  afterSave(): void {
