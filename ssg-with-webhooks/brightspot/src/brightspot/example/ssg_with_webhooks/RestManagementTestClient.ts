...
import RestManagementTest from './RestManagementTest'

export default class RestManagementTestClient extends JavaClass(
  'brightspot.example.ssg_with_webhooks.RestManagementTestClient',
  Modification.Of(RestManagementTest)
) {
  afterSave(): void {
