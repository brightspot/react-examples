...
import MappingEndpoint from './MappingEndpoint'

export default class MappingEndpointClient extends JavaClass(
  'brightspot.example.static_persisted_queries.MappingEndpointClient',
  Modification.Of(MappingEndpoint)
) {
  afterSave(): void {
